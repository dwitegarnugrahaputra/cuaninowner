...
WebUI.verifyElementText(findTestObject('Page_cuaninowner/Page_cuaninowner/div_Americano ID A1DCBE4E'), 'Americano')

WebUI.verifyElementPresent(findTestObject('Page_cuaninowner/span_Menu Management'), 30)

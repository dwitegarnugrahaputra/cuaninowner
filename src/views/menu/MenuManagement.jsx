...
import { 
  ...
  Image as ImageIcon, Trash, Save, TrendingUp
} from 'lucide-react';
    ...
    <div style={{ display: 'flex', width: '100vw', height: '100vh', backgroundColor: '#F8F9FA', fontFamily: 'sans-serif', overflow: 'hidden', margin: 0, padding: 0, position: 'relative' }}>
      ...
      <div style={{ width: '260px', backgroundColor: '#1E3A8A', color: '#ffffff', display: 'flex', flexDirection: 'column', padding: '24px 0', flexShrink: 0 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px', padding: '0 16px' }}>
          ...
          <div onClick={() => onNavigateView('stock')} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', color: '#93C5FD', borderRadius: '10px', cursor: 'pointer' }}>
            <Archive size={18} /> <span style={{ fontSize: '14px', fontWeight: '500' }}>Stock</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', backgroundColor: '#006847', borderRadius: '10px', fontWeight: 'bold', cursor: 'pointer' }}>
            <MenuIcon size={18} /> <span style={{ fontSize: '14px' }}>Menu Management</span>
          </div>
          <div onClick={() => onNavigateView('staff')} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 16px', color: '#93C5FD', borderRadius: '10px', cursor: 'pointer' }}>
            <Users size={18} /> <span style={{ fontSize: '14px', fontWeight: '500' }}>Staf Management</span>
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '32px', display: 'flex', flexDirection: 'column', gap: '24px', boxSizing: 'border-box' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            {/* Trigger Klik Mengubah State Modal Jadi True */}
              ...
              <tbody>
                {[
                  ...
                  <tr key={idx} style={{ borderBottom: '1px solid #F3F4F6', color: '#111827' }}>
                    ...
                    <td style={{ padding: '16px 24px', textAlign: 'right', color: '#9CA3AF' }}><div style={{ display: 'flex', justifyContent: 'flex-end', gap: '16px' }}><Edit2 size={16} /><Trash2 size={16} /></div></td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      {/* =======================================================================
          ================= WINDOW POPUP OVERLAY (image_89a16a.png) =================
          ======================================================================= */}
      {isModalOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', backgroundColor: 'rgba(0, 0, 0, 0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          ...
          <div style={{ width: '920px', backgroundColor: '#ffffff', borderRadius: '16px', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)', display: 'flex', flexDirection: 'column', overflow: 'hidden', animation: 'fadeIn 0.2s ease-out' }}>
            ...
            {/* 2. MODAL FORM BODY CONTROLLER (SPLIT FORM VS PROFIT ANALYSIS) */}
            <div style={{ padding: '24px', display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: '24px', overflowY: 'auto', maxHeight: '70vh' }}>
              
              {/* LEFT COLUMN COMPONENTS: INPUT FORMS */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                
                {/* Section Sub A: Informasi Dasar */}
                <div>
                ...
                <div style={{ borderTop: '1px dashed #E5E7EB', paddingTop: '16px' }}>
                  ...
                  {/* Resep Mapping Sheet Frame Grid */}
              ...
              {/* RIGHT COLUMN COMPONENTS: IMAGE & PROFIT ANALYSIS DYNAMICS */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                
                {/* Box A: Upload Foto Menu Grid Box */}
                ...
                {/* Box B: Profit Analysis Widget Dashboard (Deep Blue Dark Box) */}
                <div style={{ backgroundColor: '#06163A', borderRadius: '14px', padding: '20px', color: '#ffffff', display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  ...
                  {/* Dual Info Block Modal/Margin Profit */}
            ...
            {/* 3. MODAL BAR FOOTER ACTION BUTTONS */}
